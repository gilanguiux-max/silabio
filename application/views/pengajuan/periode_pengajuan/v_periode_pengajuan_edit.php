    ...
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    ?>
                  <?php echo form_dropdown('sumber_pendanaan',$sd,$row->sumber_pendanaan,'id="sumber_pendanaan" class="form-control select2"');?>
        ...
        <div class="form-group">
                ...
                ?>
                  <?php echo form_dropdown('status_pengajuan',$sp,$row->status_pengajuan,'id="status_pengajuan" class="form-control select2"');?>
