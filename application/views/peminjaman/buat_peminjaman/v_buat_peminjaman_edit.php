        ...
        <div class="form-group">
            ...
            <div>
                ...
                <?php foreach ($bahan->result() as $bahan): ?>
                    <option value="<?= $bahan->id_nama_bahan ?>" <?= $bahan->id_nama_bahan == $row->nama_bahan ? "selected" : null ?>><?= $bahan->nama_bahan ?></option>
                <?php endforeach; ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div>
                ...
                <?php foreach ($alat->result() as $alat): ?>
                    <option value="<?= $alat->id_nama_alat ?>" <?= $alat->id_nama_alat == $row->nama_alat ? "selected" : null ?>><?= $alat->nama_alat ?></option>
                <?php endforeach; ?>
                </select>
            </div>
