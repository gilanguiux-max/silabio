      ...
      <div class="col-lg-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">Langkah 2 (pilih bahan)- Laboratorium Silabio</h3>
          </div>
          ...
          <tr>
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '4' || $sesi == '5' || $sesi == '6' || $sesi == '7' || $sesi == '8') {
                echo button('load_silent("kelola/kelola_alat/form/sub/'.$row->id.'","#modal")','','btn btn-warning fa fw fa-cart-arrow-down','data-toggle="tooltip" title="Tambah Bahan"');
              } else {
                # code...
              }
              ?>
