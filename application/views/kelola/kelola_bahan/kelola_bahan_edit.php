...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div>
                <select class="form-control" name="id_nama_bahan" id="id_nama_bahan">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'stock','class'=>'form-control', 'id'=>'stock', 'value'=>$row->stock));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'stock_minimal','class'=>'form-control', 'id'=>'stock_minimal', 'value'=>$row->stock_minimal));?>
            <?php echo form_error('kode');?>
            <span id="check_data"></span>
            </div>
        </div>
...
function save()
{
   //$('#tombol').attr('disabled','disabled');
    ...
    if (path == '') {
        $.ajax({
        type: "POST",
        url: "<?= site_url('kelola/kelola_bahan/show_editForm/"+ida+"')?>",
        dataType:'json',
        data: {
            id        : $("#id").val(),
            id_nama_bahan       : $("#id_nama_bahan").val(),
            satuan_bahan       : $("#satuan_bahan").val(),
            kategori           : $("#kategori").val(),
            stock           : $("#stock").val(),
            stock_minimal           : $("#stock_minimal").val(),
            lokasi           : $("#lokasi").val(),
		...
		success: function(data){
		  $.growl.notice({ title: 'Sukses', message: data['msg']});      
          load_silent("kelola/kelola_bahan/","#content");
		},
      });
        ...
        $.ajaxFileUpload
          ({
            url: "<?= site_url('kelola/kelola_bahan/show_editForm_file/"+ida+"')?>",
            secureuri:false,
            fileElementId:'ufile',
            dataType: 'json',
            data: {
