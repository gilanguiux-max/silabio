...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'stock','class'=>'form-control', 'id'=>'stock'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'stock_minimal','class'=>'form-control', 'id'=>'stock_minimal'));?>
...
function save()
{
    ...
    if (path == '') {
        $.ajax({
        type: "POST",
        url: "<?= site_url('kelola/kelola_bahan/show_addForm/')?>",
        dataType:'json',
        data: {
        ...
        $.ajaxFileUpload
          ({
            url: "<?= site_url('kelola/kelola_bahan/show_addForm_file/')?>",
            secureuri:false,
            fileElementId:'ufile',
            dataType: 'json',
            data: {
