      ...
      <div class="col-lg-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '4' || $sesi == '6') {
                echo button('load_silent("kelola/kelola_penggantian/form/base","#modal")','Tambah Penggantian','btn btn-success');
              } else {
                # code...
              }
              ?>
          ...
          <tr>
            ...
            <td align="center" class="badge <?= $row->status_penggantian == 'sudah diganti' ? 'bg-green' : 'bg-red'?>"><?= $row->status_penggantian ?></td>
