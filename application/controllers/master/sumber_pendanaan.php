...
class sumber_pendanaan extends CI_Controller {
	...
	public function show_addForm()
	{
		...
		{
			$datapost = get_post_data(array('id','sumber_pendanaan'));
	...
	$this->form_validation->set_error_delimiters('<span class="error-span">', '</span>');
		...
		else
		{
			...
			$this->fungsi->catat($datapost,"Mengedit Master sumber_pendanaan dengan data sbb:",true);
		}
	}
	public function delete($id)
	{
		...
		$this->fungsi->run_js('load_silent("master/sumber_pendanaan","#content")');
		$this->fungsi->message_box("Data Sumber Pendanaan berhasil dihapus...","notice");
