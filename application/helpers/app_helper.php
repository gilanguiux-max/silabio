...
function parse_avatar_benda($avatar,$nama,$size,$class='')
{
    if($avatar == '')
    {
        $pic = 'tool.png';
...
function status_peminjam($peminjam)
{
    $status="";
    if($peminjam=="mhs"){
        $status="Mahasiswa";
...
function status_peminjaman($peminjaman)
{
    $status="";
    if($peminjaman==1){
        $status="Dipinjam";
...
function badge_peminjaman($peminjaman)
{
    $status="";
    if($peminjaman==1){
        $status="bg-yellow";
